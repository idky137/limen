...
///
/// This is the public entry to the generator. It currently emits a non-`std`
/// graph flavor (no owned bundle transfer), adequate for `no_std` execution.
///
/// # Returns
/// `TokenStream2` containing the concrete graph type and trait impls.
