...
use limen_core::types::{DeadlineNs, NodeIndex, PortIndex};
    ...
    fn summaries_internal(&self) -> [NodeSummary; 5] {
        ...
        [
            NodeSummary {
                ...
                backpressure: limen_core::policy::WatermarkState::BelowSoft,
            },
            NodeSummary {
                index: NodeIndex(1),
                earliest_deadline: None,
...
impl<S, P, M, O, K, P1, P2p, P3, P4, Q1, Q2, Q3, Q4, C, T> crate::runtime::p2_single::GraphP2<C, T>
    for SimpleChain5P2<SimpleChain5<S, P, M, O, K, P1, P2p, P3, P4, Q1, Q2, Q3, Q4>>
where
    P1: Payload,
    P2p: Payload,
    P3: Payload,
